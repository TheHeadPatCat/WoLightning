...
public sealed class Plugin : IDalamudPlugin
{
    ...
    public const string currentVersion = "0.2.5.6";
    public const string randomKey = "0100001011100111000010000111111011101010000111001110101011101101110101110111100011";
